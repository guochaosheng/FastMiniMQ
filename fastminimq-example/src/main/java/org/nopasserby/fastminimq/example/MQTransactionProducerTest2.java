...
public class MQTransactionProducerTest2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < batchCount; i++) {
            ...
            MQFuture<MQRecord> future = producer.sendTxMsg(topic, body.getBytes(), Transaction.PREPARE_FOR_CONSUMER);
            MQRecord record = future.get();
            producer.commit(record, Transaction.COMMIT_FOR_CONSUMER).get();
